...
<div style="display: table-cell;
	...
	<h1><a href="search" style="text-decoration: none;"><font color="chucknorris">Search</font></a></h1>
</div>
</center>
</div>
...
<div style="display: table-cell;
    vertical-align: middle;">
	<h1><a href="autocomplete" style="text-decoration: none; display: table-cell;"><font color="chucknorris">AutoComplete</font></a></h1>
</div>
</center>
<div class="browse" style="float: left; width: 50%; height: 100%">
<center>
<div style="display: table-cell;
    vertical-align: middle;">
	<h1><a href="browse" style="text-decoration: none; display: table-cell;"><font color="chucknorris">Browse</font></a></h1>
</div>
</center>
</div>
</body>
